...
function Navbar() {
  ...
  return (
    <div className="bg-transparent z-10 fixed w-full h-[3.5em] flex justify-between items-center p-10">
      ...
      <ul
        className={`flex-col md:flex md:flex-row gap-10 bg-transparent md:bg-transparent transition-all duration-300 ease-in-out ${
          isOpen
            ? 'fixed top-[3.5em] right-0 w-full md:static md:w-auto'
            : 'fixed top-[-200px] right-0 w-full md:static md:w-auto'
        }`}
      >
